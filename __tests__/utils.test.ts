...
const filenamesDataProvider = [
  {
    filename: 'mockery_1.1.1_Darwin_x86_64.tar.gz',
    wantOs: 'darwin',
    wantArch: 'x64',
  },
  {
    filename: 'mockery_1.1.1_Darwin_arm64.tar.gz',
    wantOs: 'darwin',
    wantArch: 'arm64',
  },
  {
    filename: 'mockery_1.1.1_Linux_x86_64.tar.gz',
    wantOs: 'linux',
    wantArch: 'x64',
  },
  {
    filename: 'mockery_1.1.1_Linux_arm64.tar.gz',
    wantOs: 'linux',
    wantArch: 'arm64',
  },
  {
    filename: 'mockery_1.1.1_Windows_x86_64.tar.gz',
    wantOs: 'win32',
    wantArch: 'x64',
  },
  {
    filename: 'mockery_1.1.1_Cat_x128.tar.gz',
    wantOs: undefined,
    wantArch: undefined,
  },
];
...
test('can prepare download url', () => {
  ...
  expect(url).toBe(
    'https://github.com/vektra/mockery/releases/download/v1.0.0/somefile.txt',
  );
});
